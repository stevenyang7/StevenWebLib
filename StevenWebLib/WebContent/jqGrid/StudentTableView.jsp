...
<title>学习使用jqGrid</title>
<link rel="stylesheet" type="text/css" 
	href="../css/smoothness/jquery-ui-1.10.2.custom.css" />
<link rel="stylesheet" type="text/css" href="./jquery.jqGrid-4.5.2/css/ui.jqgrid.css" />  
<script src="./jquery.jqGrid-4.5.2/js/jquery-1.9.0.min.js" type="text/javascript"></script>
<script src="./jquery.jqGrid-4.5.2/js/i18n/grid.locale-cn.js" type="text/javascript"></script>  
